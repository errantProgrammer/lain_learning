...
Este nivel te sitúa en el lado del llamado. Tu función «solve» se invoca como «solve(check_callee_clobbered)» (el puntero está en rdi), y tu llamante tiene valores activos en rbx, rbp, r12, r13, r14 y r15 que espera recuperar sin que se hayan modificado.
