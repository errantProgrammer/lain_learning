...
\begin{titlepage}
	...
	\begin{minipage}{0.75\textwidth}
		...
		\vspace{0.3cm}
		{\footnotesize \color{csecCyan}\textbf{v1.2 (2026)} \quad \color{csecBorder}\textbar\quad \color{csecMuted}\today}
	\end{minipage}
	\vspace*{1.2cm}
\end{titlepage}
...
% Profundidad ejecutiva: Solo capítulos en el Índice General (evita índices masivos).
% Cambiar a {section} si se desean visualizar máquinas/secciones principales.
